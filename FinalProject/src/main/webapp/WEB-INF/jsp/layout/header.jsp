...
<html>
  <head>
    ...
    <script
      ...
      src="${contextRoot}/js/jquery-3.6.0.min.js"
    ></script>
    <script
      type="text/javascript"
      src="${contextRoot}/jQueryconfirm/jquery-confirm.js"
    ></script>
    ...
    <script
      type="text/javascript"
      src="${contextRoot}/js/sweetalert2.all.min.js"
    ></script>
  ...
  <body style="background-color: rgb(243, 243, 245)">
    ...
    >
      <a
        ...
        href="http://localhost:8081/jotravel/index"
      ...
      <c:if test="${sessionScope.loginuser.accountId != null}">
        <a class="nav-link" href="http://localhost:8081/jotravel/back/loginout">
          <button
            type="button"
            class="btn btn-secondary"
            style="position: absolute; right: 90px; top: 11px"
          >
            登出
          </button></a
        >
        ...
        >
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a class="dropdown-item" href="${contextRoot}/back/member/add"
                >新增會員資料</a
              >
              <a class="dropdown-item" href="${contextRoot}/back/member/findall"
                >所有會員資訊</a
              >
              <a class="dropdown-item" href="${contextRoot}/back/login/insert"
                >新增帳號</a
              >
              <a class="dropdown-item" href="${contextRoot}/back/login/findall"
                >所有帳號</a
              >
              <a
                class="dropdown-item"
                href="${contextRoot}/login.password.update"
                >修改密碼</a
              >
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a class="dropdown-item" href="${contextRoot}/back/allProduct"
                >所有商品</a
              >
              <a class="dropdown-item" href="${contextRoot}/back/addProduct"
                >新增商品</a
              >
              <a
                class="dropdown-item"
                href="${contextRoot}/back/ProductComment/all"
                >商品評論</a
              >
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="/jotravel/back/allOrder">所有訂單</a>
              <a href="${contextRoot}/back/stOrder">統計數據</a>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a
                class="dropdown-item"
                href="${contextRoot}/staff/message/selectAll"
                >所有案件</a
              >
            </div>
          </div>
