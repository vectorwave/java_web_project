...
<div id="GIFormContainer1">
        ...
        <input type="text" name="accountName"  class="inputBoxAdd"/></br></br>

        <label class="GIFLabel">密碼： </label>
        <input type="password" name="pwd"  class="inputBoxAdd"/></br></br>
        ...
        <form:textarea path="guideDescription" class="textareaAdd"/></br></br></br></br>
        <button type="button" onclick="submitForm(form)" class="btn btn-outline-success">送出</button>
      </div>

      <div id="rightPart">

        <label class="GIFLabel">生日： </label>
        <form:input type="date" path="guideBirthday" class="inputBoxAdd"/></br></br>
