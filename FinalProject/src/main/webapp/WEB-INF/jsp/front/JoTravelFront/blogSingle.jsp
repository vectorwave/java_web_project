                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    ...
                                    <div class="detials">
                                        ...
                                        <p>Prev Post</p>
                                        <a href="http://localhost:8081/jotravel/front/blogPage/detail?id=${article.articleId-1}"><h4>上一篇</h4></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                    <div class="detials">
                                        <p>Next Post</p>
                                        <a href="http://localhost:8081/jotravel/front/blogPage/detail?id=${article.articleId+1}"><h4>下一篇</h4></a>
                                    </div>
                                    <div class="arrow">
